public class Conjunto{
	...
	Conjunto barramento(){
		//Esse método retorna o conjunto cujos os elementos pertencem ao universo e não pertence a esse conjunto.
		Conjunto conjuntoBarrado;
		Conjunto universo = new Conjunto(50);
		for(int i = 0;i < 50;i++){
			universo.inserirElemento(i);
		}
		conjuntoBarrado = universo.conjuntoDiferenca(this);

		return conjuntoBarrado;
	}
